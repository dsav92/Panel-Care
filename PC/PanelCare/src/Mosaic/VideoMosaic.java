...
public class VideoMosaic {

	public static String path;
	
	public static Image workVideo(String path) throws IOException {
	...
	public static void main( String args[] ) throws IOException {
		...
		ImageIO.write(gui.getImage(0, 1), "jpg", new File("C:/Users/Administrator/Desktop/prova0.jpg"));
	}
